# Narcissistic number is same as the Armstrong number
# Narcissistic number: Approach 1
...
if(sum_of_powers == original_number):
    ...
    print("This number is not an Narcissistic Number")


# Narcissistic number: Approach 2
"""
number = int(input("Enter the number: "))
numStr = str(number)
exponent = len(numStr)
